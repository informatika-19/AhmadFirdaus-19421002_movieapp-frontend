        ...
        <div class="q-mb-xl">
          ...
          >
            ...
            <q-carousel-slide name="soft-jazz">
              <q-video
                class="absolute-full"
                src="https://www.youtube.com/embed/p2q_nS_Y_9o?t=4"
              />
            </q-carousel-slide>
          </q-carousel>
        </div>
        <div class="row q-pa-md">
          <div class="col-md-4 col-xs-12" v-for="(movie, i) in data" :key="i">
            <q-card>
              <q-img :src="`http://localhost:5000/${movie.image}`" :ratio="16/9" />
